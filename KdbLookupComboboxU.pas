...
uses Variants, Windows, SysUtils, Messages, Vcl.Controls, Vcl.Forms, Classes,
     Vcl.Graphics, Vcl.Menus, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Mask, Vcl.Buttons, ComCtrls, Data.DB;
...
{ TKDBEdit }
  ...
  TKDBEdit = class(TCustomMaskEdit)
  private
...
{ TKDBCheckBox }
  ...
  TKDBCheckBox = class(TCustomCheckBox)
  private
    FDataLink: TFieldDataLink;
    FValueCheck: string;
...
{ TKDBListBox }
  ...
  TKDBListBox = class(TCustomListBox)
  private
    FDataLink: TFieldDataLink;
    procedure DataChange(Sender: TObject);
    procedure UpdateData(Sender: TObject);
...
{ TKDBRadioGroup }
  ...
  TKDBRadioGroup = class(TCustomRadioGroup)
  private
    FDataLink: TFieldDataLink;
    FValue: string;
    FValues: TStrings;
...
{ TKDBImage }
  ...
  TKDBImage = class(TCustomControl)
  private
    FDataLink: TFieldDataLink;
    FPicture: TPicture;
...
{ TKDBNavigator }
  ...
  TKDBNavigator = class (TCustomPanel)
  private
...
{ TNavDataLink }
  ...
  private
    FNavigator: TKDBNavigator;
  protected
    procedure EditingChanged; override;
    procedure DataSetChanged; override;
    procedure ActiveChanged; override;
  public
    constructor Create(ANav: TKDBNavigator);
    destructor Destroy; override;
  end;

{ TKDBLookupControl }

  TKDBLookupControl = class;

  TDataSourceLink = class(TDataLink)
  private
    FDBLookupControl: TKDBLookupControl;
  protected
    procedure FocusControl(Field: TFieldRef); override;
    procedure ActiveChanged; override;
    procedure LayoutChanged; override;
  ...
  TKDBLookupControl = class(TCustomControl)
  private
...
{ TKDBLookupListBox }
  ...
  TKDBLookupListBox = class(TKDBLookupControl)
  private
...
{ TKDBLookupComboBox }
  ...
  TPopupDataList = class(TKDBLookupListBox)
  private
  ...
  TKDBLookupComboBox = class(TKDBLookupControl)
  private
...
{ TKDBRichEdit }
  ...
  TKDBRichEdit = class(TCustomRichEdit)
  private
    FDataLink: TFieldDataLink;
    FAutoDisplay: Boolean;
    FFocused: Boolean;
...
begin
  RegisterComponents('Kamran Component', [TKDBLookupComboBox]);
end;
...
{ AField is needed because TKDBLookupComboBox, for its combobox, uses FListField
...
procedure TKDBEdit.ResetMaxLength;
var
  F: TField;
begin
...
procedure TKDBEdit.Notification(AComponent: TComponent;
...
function TKDBEdit.UseRightToLeftAlignment: Boolean;
begin
...
procedure TKDBEdit.KeyPress(var Key: Char);
begin
...
function TKDBEdit.EditCanModify: Boolean;
begin
  Result := FDataLink.Edit;
end;

procedure TKDBEdit.Reset;
begin
  FDataLink.Reset;
  SelectAll;
end;

procedure TKDBEdit.SetFocused(Value: Boolean);
begin
...
procedure TKDBEdit.Change;
begin
  FDataLink.Modified;
  inherited Change;
end;

function TKDBEdit.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBEdit.SetDataSource(Value: TDataSource);
begin
...
function TKDBEdit.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBEdit.SetDataField(const Value: string);
begin
...
function TKDBEdit.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBEdit.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBEdit.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TKDBEdit.ActiveChange(Sender: TObject);
begin
  ResetMaxLength;
end;

procedure TKDBEdit.DataChange(Sender: TObject);
begin
...
procedure TKDBEdit.EditingChange(Sender: TObject);
begin
  inherited ReadOnly := not FDataLink.Editing;
end;

procedure TKDBEdit.UpdateData(Sender: TObject);
begin
  ValidateEdit;
  FDataLink.Field.Text := Text;
end;

procedure TKDBEdit.WMUndo(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBEdit.WMPaste(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBEdit.WMCut(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBEdit.CMEnter(var Message: TCMEnter);
begin
  SetFocused(True);
  inherited;
...
procedure TKDBEdit.CMExit(var Message: TCMExit);
begin
  try
...
procedure TKDBEdit.WMPaint(var Message: TWMPaint);
const
...
procedure TKDBEdit.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

function TKDBEdit.GetTextMargins: TPoint;
var
  DC: HDC;
  SaveFont: HFont;
  I: Integer;
...
function TKDBEdit.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBEdit.UpdateAction(Action: TBasicAction): Boolean;
begin
...
procedure TKDBText.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBText.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

procedure TKDBText.SetAutoSize(Value: Boolean);
begin
...
function TKDBText.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBText.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
function TKDBText.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBText.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBText.GetField: TField;
begin
  Result := FDataLink.Field;
end;

function TKDBText.GetFieldText: string;
begin
  if FDataLink.Field <> nil then
...
procedure TKDBText.DataChange(Sender: TObject);
begin
  Caption := GetFieldText;
end;

function TKDBText.GetLabelText: string;
begin
...
procedure TKDBText.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

function TKDBText.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBText.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
destructor TKDBCheckBox.Destroy;
begin
  FPaintControl.Free;
  FDataLink.Free;
  FDataLink := nil;
...
procedure TKDBCheckBox.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBCheckBox.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

function TKDBCheckBox.GetFieldState: TCheckBoxState;
var
  Text: string;
begin
  if FDatalink.Field <> nil then
...
procedure TKDBCheckBox.DataChange(Sender: TObject);
begin
  State := GetFieldState;
end;

procedure TKDBCheckBox.UpdateData(Sender: TObject);
var
  Pos: Integer;
  S: string;
begin
...
function TKDBCheckBox.ValueMatch(const ValueList, Value: string): Boolean;
var
  Pos: Integer;
begin
  Result := False;
...
function TKDBCheckBox.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBCheckBox.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
function TKDBCheckBox.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBCheckBox.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBCheckBox.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBCheckBox.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBCheckBox.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TKDBCheckBox.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  case Key of
    #8, ' ':
...
procedure TKDBCheckBox.SetValueCheck(const Value: string);
begin
  FValueCheck := Value;
  DataChange(Self);
end;

procedure TKDBCheckBox.SetValueUncheck(const Value: string);
begin
  FValueUncheck := Value;
  DataChange(Self);
end;

procedure TKDBCheckBox.WndProc(var Message: TMessage);
begin
  with Message do
...
procedure TKDBCheckBox.WMPaint(var Message: TWMPaint);
begin
...
procedure TKDBCheckBox.CMExit(var Message: TCMExit);
begin
  try
    FDataLink.UpdateRecord;
  except
...
procedure TKDBCheckBox.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

function TKDBCheckBox.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBCheckBox.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
procedure TKDBComboBox.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
procedure TKDBComboBox.CreateWnd;
begin
  inherited CreateWnd;
  SetEditReadOnly;
end;
...
procedure TKDBComboBox.SetComboText(const Value: string);
var
  I: Integer;
  Redraw: Boolean;
begin
...
function TKDBComboBox.GetComboText: string;
var
  I: Integer;
begin
...
procedure TKDBComboBox.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
procedure TKDBComboBox.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;
...
procedure TKDBComboBox.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;
...
procedure TKDBComboBox.EditingChange(Sender: TObject);
begin
  SetEditReadOnly;
end;

procedure TKDBComboBox.SetEditReadOnly;
begin
...
procedure TKDBComboBox.ComboWndProc(var Message: TMessage; ComboWnd: HWnd;
  ComboProc: Pointer);
begin
  if not (csDesigning in ComponentState) then
    case Message.Msg of
...
procedure TKDBComboBox.CMEnter(var Message: TCMEnter);
begin
  inherited;
  if SysLocale.FarEast and FDataLink.CanModify then
...
procedure TKDBComboBox.SetItems(const Value: TStrings);
begin
  inherited SetItems(Value);
  DataChange(Self);
end;

procedure TKDBCombobox.SetStyle(Value: TComboboxStyle);
begin
...
function TKDBComboBox.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;
...
function TKDBComboBox.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBComboBox.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
destructor TKDBListBox.Destroy;
begin
  FDataLink.Free;
  FDataLink := nil;
  inherited Destroy;
...
procedure TKDBListBox.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBListBox.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

procedure TKDBListBox.DataChange(Sender: TObject);
begin
  if FDataLink.Field <> nil then
...
procedure TKDBListBox.UpdateData(Sender: TObject);
begin
  if ItemIndex >= 0 then
...
function TKDBListBox.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBListBox.SetDataSource(Value: TDataSource);
begin
  FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
end;

function TKDBListBox.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBListBox.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBListBox.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBListBox.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBListBox.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TKDBListBox.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited KeyDown(Key, Shift);
...
procedure TKDBListBox.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  case Key of
    #32..#255:
...
procedure TKDBListBox.WMLButtonDown(var Message: TWMLButtonDown);
begin
...
procedure TKDBListBox.CMExit(var Message: TCMExit);
begin
  try
    FDataLink.UpdateRecord;
  except
...
procedure TKDBListBox.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

procedure TKDBListBox.SetItems(Value: TStrings);
begin
  Items.Assign(Value);
  DataChange(Self);
end;

function TKDBListBox.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBListBox.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
procedure TKDBRadioGroup.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBRadioGroup.UseRightToLeftAlignment: Boolean;
begin
  Result := inherited UseRightToLeftAlignment;
end;

procedure TKDBRadioGroup.DataChange(Sender: TObject);
begin
  if FDataLink.Field <> nil then
...
procedure TKDBRadioGroup.UpdateData(Sender: TObject);
begin
  if FDataLink.Field <> nil then FDataLink.Field.Text := Value;
end;

function TKDBRadioGroup.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBRadioGroup.SetDataSource(Value: TDataSource);
begin
  FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
end;

function TKDBRadioGroup.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBRadioGroup.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBRadioGroup.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBRadioGroup.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBRadioGroup.GetField: TField;
begin
  Result := FDataLink.Field;
end;

function TKDBRadioGroup.GetButtonValue(Index: Integer): string;
begin
...
procedure TKDBRadioGroup.SetValue(const Value: string);
var
  WasFocused: Boolean;
  I, Index: Integer;
begin
...
procedure TKDBRadioGroup.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;
...
procedure TKDBRadioGroup.SetItems(Value: TStrings);
begin
  Items.Assign(Value);
  DataChange(Self);
end;

procedure TKDBRadioGroup.SetValues(Value: TStrings);
begin
  FValues.Assign(Value);
  DataChange(Self);
end;

procedure TKDBRadioGroup.Change;
begin
  if Assigned(FOnChange) then FOnChange(Self);
end;

procedure TKDBRadioGroup.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  case Key of
    #8, ' ': FDataLink.Edit;
...
function TKDBRadioGroup.CanModify: Boolean;
begin
  Result := FDataLink.Edit;
end;

function TKDBRadioGroup.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (DataLink <> nil) and
    DataLink.ExecuteAction(Action);
end;

function TKDBRadioGroup.UpdateAction(Action: TBasicAction): Boolean;
begin
...
procedure TKDBMemo.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBMemo.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;
...
procedure TKDBMemo.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  if FMemoLoaded then
  begin
...
function TKDBMemo.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBMemo.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
function TKDBMemo.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBMemo.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBMemo.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBMemo.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBMemo.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TKDBMemo.LoadMemo;
begin
...
procedure TKDBMemo.DataChange(Sender: TObject);
begin
  if FDataLink.Field <> nil then
...
procedure TKDBMemo.EditingChange(Sender: TObject);
begin
  inherited ReadOnly := not (FDataLink.Editing and FMemoLoaded);
end;

procedure TKDBMemo.UpdateData(Sender: TObject);
begin
  FDataLink.Field.AsString := Text;
end;

procedure TKDBMemo.SetFocused(Value: Boolean);
begin
  if FFocused <> Value then
  begin
    FFocused := Value;
...
procedure TKDBMemo.WndProc(var Message: TMessage);
begin
  with Message do
    if (Msg = WM_CREATE) or (Msg = WM_WINDOWPOSCHANGED) or
...
procedure TKDBMemo.CMEnter(var Message: TCMEnter);
begin
  SetFocused(True);
  inherited;
  if SysLocale.FarEast and FDataLink.CanModify then
...
procedure TKDBMemo.CMExit(var Message: TCMExit);
begin
  try
    FDataLink.UpdateRecord;
  except
...
procedure TKDBMemo.SetAutoDisplay(Value: Boolean);
begin
...
procedure TKDBMemo.WMLButtonDblClk(var Message: TWMLButtonDblClk);
begin
  if not FMemoLoaded then LoadMemo else inherited;
end;

procedure TKDBMemo.WMCut(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBMemo.WMUndo(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBMemo.WMPaste(var Message: TMessage);
begin
  FDataLink.Edit;
  inherited;
end;

procedure TKDBMemo.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

procedure TKDBMemo.WMPaint(var Message: TWMPaint);
var
  S: string;
begin
  if not (csPaintCopy in ControlState) then inherited else
...
function TKDBMemo.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBMemo.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
function TKDBImage.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBImage.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
function TKDBImage.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBImage.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBImage.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBImage.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBImage.GetField: TField;
begin
  Result := FDataLink.Field;
end;

function TKDBImage.GetPalette: HPALETTE;
begin
  Result := 0;
...
procedure TKDBImage.SetAutoDisplay(Value: Boolean);
begin
  if FAutoDisplay <> Value then
  begin
    FAutoDisplay := Value;
...
procedure TKDBImage.SetBorderStyle(Value: TBorderStyle);
begin
...
procedure TKDBImage.SetCenter(Value: Boolean);
begin
...
procedure TKDBImage.SetPicture(Value: TPicture);
begin
  FPicture.Assign(Value);
end;

procedure TKDBImage.SetStretch(Value: Boolean);
begin
...
procedure TKDBImage.PictureChanged(Sender: TObject);
begin
...
procedure TKDBImage.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
procedure TKDBImage.LoadPicture;
begin
...
procedure TKDBImage.DataChange(Sender: TObject);
begin
  Picture.Graphic := nil;
...
procedure TKDBImage.UpdateData(Sender: TObject);
begin
...
procedure TKDBImage.CopyToClipboard;
begin
  if Picture.Graphic <> nil then Clipboard.Assign(Picture);
end;

procedure TKDBImage.CutToClipboard;
begin
...
procedure TKDBImage.PasteFromClipboard;
begin
  if Clipboard.HasFormat(CF_BITMAP) and FDataLink.Edit then
    Picture.Bitmap.Assign(Clipboard);
end;

procedure TKDBImage.CreateParams(var Params: TCreateParams);
begin
...
procedure TKDBImage.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited KeyDown(Key, Shift);
  case Key of
    VK_INSERT:
...
procedure TKDBImage.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  case Key of
    ^X: CutToClipBoard;
...
procedure TKDBImage.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

procedure TKDBImage.CMEnter(var Message: TCMEnter);
begin
  Invalidate; { Draw the focus marker }
  inherited;
end;

procedure TKDBImage.CMExit(var Message: TCMExit);
begin
  try
...
procedure TKDBImage.CMTextChanged(var Message: TMessage);
begin
  inherited;
  if not FPictureLoaded then Invalidate;
end;

procedure TKDBImage.WMLButtonDown(var Message: TWMLButtonDown);
begin
  if TabStop and CanFocus then SetFocus;
  inherited;
end;

procedure TKDBImage.WMLButtonDblClk(var Message: TWMLButtonDblClk);
begin
  LoadPicture;
  inherited;
end;

procedure TKDBImage.WMCut(var Message: TMessage);
begin
  CutToClipboard;
end;

procedure TKDBImage.WMCopy(var Message: TMessage);
begin
  CopyToClipboard;
end;

procedure TKDBImage.WMPaste(var Message: TMessage);
begin
  PasteFromClipboard;
end;

procedure TKDBImage.WMSize(var Message: TMessage);
begin
  inherited;
  Invalidate;
end;

function TKDBImage.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBImage.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
constructor TKDBNavigator.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
destructor TKDBNavigator.Destroy;
begin
  FDefHints.Free;
  FDataLink.Free;
  FHints.Free;
...
procedure TKDBNavigator.InitButtons;
var
  I: TNavigateBtn;
  Btn: TNavButton;
  X: Integer;
...
procedure TKDBNavigator.InitHints;
var
  I: Integer;
  J: TNavigateBtn;
begin
...
procedure TKDBNavigator.HintsChanged(Sender: TObject);
begin
  InitHints;
end;

procedure TKDBNavigator.SetFlat(Value: Boolean);
var
  I: TNavigateBtn;
begin
  if FFlat <> Value then
...
procedure TKDBNavigator.SetHints(Value: TStrings);
begin
...
function TKDBNavigator.GetHints: TStrings;
begin
...
procedure TKDBNavigator.GetChildren(Proc: TGetChildProc; Root: TComponent);
begin
end;

procedure TKDBNavigator.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
procedure TKDBNavigator.SetVisible(Value: TButtonSet);
var
  I: TNavigateBtn;
  W, H: Integer;
begin
...
procedure TKDBNavigator.CalcMinSize(var W, H: Integer);
var
  Count: Integer;
  I: TNavigateBtn;
begin
...
procedure TKDBNavigator.SetSize(var W: Integer; var H: Integer);
var
  Count: Integer;
  I: TNavigateBtn;
...
procedure TKDBNavigator.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
var
  W, H: Integer;
begin
  W := AWidth;
...
procedure TKDBNavigator.WMSize(var Message: TWMSize);
var
  W, H: Integer;
begin
  inherited;
...
procedure TKDBNavigator.WMWindowPosChanging(var Message: TWMWindowPosChanging);
begin
  inherited;
...
procedure TKDBNavigator.ClickHandler(Sender: TObject);
begin
  BtnClick (TNavButton (Sender).Index);
end;

procedure TKDBNavigator.BtnMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
...
procedure TKDBNavigator.BtnClick(Index: TNavigateBtn);
begin
...
procedure TKDBNavigator.WMSetFocus(var Message: TWMSetFocus);
begin
  Buttons[FocusedButton].Invalidate;
end;

procedure TKDBNavigator.WMKillFocus(var Message: TWMKillFocus);
begin
  Buttons[FocusedButton].Invalidate;
end;

procedure TKDBNavigator.KeyDown(var Key: Word; Shift: TShiftState);
var
...
procedure TKDBNavigator.WMGetDlgCode(var Message: TWMGetDlgCode);
begin
  Message.Result := DLGC_WANTARROWS;
end;

procedure TKDBNavigator.DataChanged;
var
...
procedure TKDBNavigator.EditingChanged;
var
  CanModify: Boolean;
begin
...
procedure TKDBNavigator.ActiveChanged;
var
  I: TNavigateBtn;
begin
...
procedure TKDBNavigator.CMEnabledChanged(var Message: TMessage);
begin
  inherited;
...
procedure TKDBNavigator.SetDataSource(Value: TDataSource);
begin
  FDataLink.DataSource := Value;
  if not (csLoading in ComponentState) then
    ActiveChanged;
...
function TKDBNavigator.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBNavigator.Loaded;
var
  W, H: Integer;
begin
  inherited Loaded;
...
begin
  ...
  if (GetFocus = Parent.Handle) and
     (FIndex = TKDBNavigator (Parent).FocusedButton) then
  begin
...
constructor TNavDataLink.Create(ANav: TKDBNavigator);
begin
  inherited Create;
  FNavigator := ANav;
  VisualControl := True;
...
constructor TKDBLookupControl.Create(AOwner: TComponent);
const
...
destructor TKDBLookupControl.Destroy;
begin
  inherited Destroy;
  FListFields.Free;
  FListFields := nil;
...
procedure TKDBLookupControl.DataLinkRecordChanged(Field: TField);
begin
...
function TKDBLookupControl.GetBorderSize: Integer;
var
  Params: TCreateParams;
  R: TRect;
begin
...
function TKDBLookupControl.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

function TKDBLookupControl.GetKeyFieldName: string;
begin
  if FLookupMode then Result := '' else Result := FKeyFieldName;
end;

function TKDBLookupControl.GetListSource: TDataSource;
begin
  if FLookupMode then Result := nil else Result := FListLink.DataSource;
end;

function TKDBLookupControl.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

function TKDBLookupControl.GetTextHeight: Integer;
var
  DC: HDC;
  SaveFont: HFont;
  Metrics: TTextMetric;
...
procedure TKDBLookupControl.KeyValueChanged;
begin
end;

procedure TKDBLookupControl.UpdateListFields;
var
  DataSet: TDataSet;
  ResultField: TField;
begin
...
procedure TKDBLookupControl.ListLinkDataChanged;
begin
end;

function TKDBLookupControl.LocateKey: Boolean;
var
  KeySave: Variant;
begin
  Result := False;
...
procedure TKDBLookupControl.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
...
procedure TKDBLookupControl.ProcessSearchKey(Key: Char);
var
  TickCount: Integer;
  S: string;
  CharMsg: TMsg;
...
procedure TKDBLookupControl.SelectKeyValue(const Value: Variant);
begin
  if FMasterField <> nil then
  begin
    if FDataLink.Edit then
...
procedure TKDBLookupControl.SetDataFieldName(const Value: string);
begin
...
procedure TKDBLookupControl.SetDataSource(Value: TDataSource);
begin
  if not (FDataLink.DataSourceFixed and (csLoading in ComponentState)) then
    FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
...
procedure TKDBLookupControl.SetKeyFieldName(const Value: string);
begin
  CheckNotLookup;
...
procedure TKDBLookupControl.SetKeyValue(const Value: Variant);
begin
...
procedure TKDBLookupControl.SetListFieldName(const Value: string);
begin
...
procedure TKDBLookupControl.SetListSource(Value: TDataSource);
begin
  CheckNotLookup;
...
procedure TKDBLookupControl.SetLookupMode(Value: Boolean);
begin
...
procedure TKDBLookupControl.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

procedure TKDBLookupControl.WMGetDlgCode(var Message: TMessage);
begin
  Message.Result := DLGC_WANTARROWS or DLGC_WANTCHARS;
end;

procedure TKDBLookupControl.WMKillFocus(var Message: TMessage);
begin
  FHasFocus := False;
  inherited;
  Invalidate;
...
procedure TKDBLookupControl.WMSetFocus(var Message: TMessage);
begin
  SearchText := '';
  FHasFocus := True;
  inherited;
...
procedure TKDBLookupControl.CMEnabledChanged(var Message: TMessage);
begin
  inherited;
  Invalidate;
end;

procedure TKDBLookupControl.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

function TKDBLookupControl.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBLookupControl.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;

procedure TKDBLookupControl.WMKeyDown(var Message: TWMKeyDown);
begin
...
procedure TKDBLookupListBox.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  with Params do
    if FBorderStyle = bsSingle then
...
procedure TKDBLookupListBox.CreateWnd;
begin
  inherited CreateWnd;
  UpdateScrollBar;
end;

function TKDBLookupListBox.GetKeyIndex: Integer;
var
  FieldValue: Variant;
begin
...
procedure TKDBLookupListBox.KeyDown(var Key: Word; Shift: TShiftState);
var
...
procedure TKDBLookupListBox.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  ProcessSearchKey(Key);
end;

procedure TKDBLookupListBox.KeyValueChanged;
begin
...
procedure TKDBLookupListBox.UpdateListFields;
begin
  try
    inherited;
  finally
...
procedure TKDBLookupListBox.ListLinkDataChanged;
begin
  if ListActive then
  begin
...
procedure TKDBLookupListBox.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TKDBLookupListBox.MouseMove(Shift: TShiftState; X, Y: Integer);
begin
  if FTracking then
  begin
    SelectItemAt(X, Y);
...
procedure TKDBLookupListBox.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  if FTracking then
  begin
...
procedure TKDBLookupListBox.Paint;
var
...
procedure TKDBLookupListBox.SelectCurrent;
begin
  FLockPosition := True;
  try
    SelectKeyValue(FKeyField.Value);
...
procedure TKDBLookupListBox.SelectItemAt(X, Y: Integer);
var
  Delta: Integer;
begin
  if Y < 0 then Y := 0;
...
procedure TKDBLookupListBox.SetBorderStyle(Value: TBorderStyle);
begin
  if FBorderStyle <> Value then
  begin
    FBorderStyle := Value;
...
procedure TKDBLookupListBox.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
var
...
function TKDBLookupListBox.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

procedure TKDBLookupListBox.SetRowCount(Value: Integer);
begin
...
procedure TKDBLookupListBox.StopTimer;
begin
...
procedure TKDBLookupListBox.StopTracking;
begin
  if FTracking then
  begin
    StopTimer;
...
procedure TKDBLookupListBox.TimerScroll;
var
...
procedure TKDBLookupListBox.UpdateScrollBar;
var
  Pos, Max: Integer;
...
procedure TKDBLookupListBox.CMCtl3DChanged(var Message: TMessage);
begin
...
procedure TKDBLookupListBox.CMFontChanged(var Message: TMessage);
begin
  inherited;
  Height := Height;
end;

procedure TKDBLookupListBox.WMCancelMode(var Message: TMessage);
begin
  StopTracking;
  inherited;
end;

procedure TKDBLookupListBox.WMTimer(var Message: TMessage);
begin
  TimerScroll;
end;

procedure TKDBLookupListBox.WMVScroll(var Message: TWMVScroll);
begin
  SearchText := '';
...
function TKDBLookupListBox.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBLookupListBox.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
...
procedure TKDBLookupComboBox.CloseUp(Accept: Boolean);
var
  ListValue: Variant;
begin
...
procedure TKDBLookupComboBox.CMBiDiModeChanged(var Message: TMessage);
begin
  inherited;
  FDataList.BiDiMode := BiDiMode;
end;

procedure TKDBLookupComboBox.CMDialogKey(var Message: TCMDialogKey);
begin
...
procedure TKDBLookupComboBox.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  with Params do
    if NewStyleControls and Ctl3D then
...
procedure TKDBLookupComboBox.DropDown;
var
  P: TPoint;
  I, Y: Integer;
  S: string;
...
procedure TKDBLookupComboBox.KeyDown(var Key: Word; Shift: TShiftState);
var
  Delta: Integer;
begin
  inherited KeyDown(Key, Shift);
...
procedure TKDBLookupComboBox.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  if FListVisible then
...
procedure TKDBLookupComboBox.KeyValueChanged;
begin
  if FLookupMode then
  begin
...
procedure TKDBLookupComboBox.UpdateListFields;
begin
  inherited;
  KeyValueChanged;
end;

procedure TKDBLookupComboBox.ListMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if Button = mbLeft then
...
procedure TKDBLookupComboBox.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  if Button = mbLeft then
  begin
...
procedure TKDBLookupComboBox.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  ListPos: TPoint;
...
procedure TKDBLookupComboBox.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  StopTracking;
  inherited MouseUp(Button, Shift, X, Y);
...
procedure TKDBLookupComboBox.Paint;
var
  W, X, Flags: Integer;
  Text: string;
  AAlignment: TAlignment;
...
procedure TKDBLookupComboBox.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
  inherited SetBounds(ALeft, ATop, AWidth, GetTextHeight + GetBorderSize + 4);
end;

function TKDBLookupComboBox.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

procedure TKDBLookupComboBox.StopTracking;
begin
  if FTracking then
  begin
    TrackButton(-1, -1);
...
procedure TKDBLookupComboBox.TrackButton(X, Y: Integer);
var
  NewState: Boolean;
begin
...
procedure TKDBLookupComboBox.CMCancelMode(var Message: TCMCancelMode);
begin
  if (Message.Sender <> Self) and (Message.Sender <> FDataList) then
    CloseUp(False);
end;

procedure TKDBLookupComboBox.CMCtl3DChanged(var Message: TMessage);
begin
  if NewStyleControls then
  begin
    RecreateWnd;
...
procedure TKDBLookupComboBox.CMFontChanged(var Message: TMessage);
begin
  inherited;
  Height := 0;
end;

procedure TKDBLookupComboBox.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;

procedure TKDBLookupComboBox.WMCancelMode(var Message: TMessage);
begin
  StopTracking;
  inherited;
end;

procedure TKDBLookupComboBox.WMKillFocus(var Message: TWMKillFocus);
begin
  inherited;
  CloseUp(False);
end;

function TKDBLookupComboBox.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBLookupComboBox.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;

procedure TKDBLookupComboBox.CMMouseEnter(var Message: TMessage);
begin
  inherited;
...
procedure TKDBLookupComboBox.CMMouseLeave(var Message: TMessage);
begin
  inherited;
...
procedure TKDBRichEdit.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) and (FDataLink <> nil) and
...
function TKDBRichEdit.UseRightToLeftAlignment: Boolean;
begin
  Result := DBUseRightToLeftAlignment(Self, Field);
end;

procedure TKDBRichEdit.BeginEditing;
begin
...
procedure TKDBRichEdit.KeyPress(var Key: Char);
begin
  inherited KeyPress(Key);
  if FMemoLoaded then
  begin
...
function TKDBRichEdit.GetDataSource: TDataSource;
begin
  Result := FDataLink.DataSource;
end;

procedure TKDBRichEdit.SetDataSource(Value: TDataSource);
begin
  FDataLink.DataSource := Value;
  if Value <> nil then Value.FreeNotification(Self);
end;

function TKDBRichEdit.GetDataField: string;
begin
  Result := FDataLink.FieldName;
end;

procedure TKDBRichEdit.SetDataField(const Value: string);
begin
  FDataLink.FieldName := Value;
end;

function TKDBRichEdit.GetReadOnly: Boolean;
begin
  Result := FDataLink.ReadOnly;
end;

procedure TKDBRichEdit.SetReadOnly(Value: Boolean);
begin
  FDataLink.ReadOnly := Value;
end;

function TKDBRichEdit.GetField: TField;
begin
  Result := FDataLink.Field;
end;

procedure TKDBRichEdit.LoadMemo;
begin
  if not FMemoLoaded and Assigned(FDataLink.Field) and FDataLink.Field.IsBlob then
  begin
    try
...
procedure TKDBRichEdit.DataChange(Sender: TObject);
begin
  if FDataLink.Field <> nil then
    if FDataLink.Field.IsBlob then
    begin
...
procedure TKDBRichEdit.EditingChange(Sender: TObject);
begin
  inherited ReadOnly := not (FDataLink.Editing and FMemoLoaded);
end;

procedure TKDBRichEdit.UpdateData(Sender: TObject);
begin
  if FDataLink.Field.IsBlob then
...
procedure TKDBRichEdit.SetFocused(Value: Boolean);
begin
  if FFocused <> Value then
  begin
    FFocused := Value;
...
procedure TKDBRichEdit.CMEnter(var Message: TCMEnter);
begin
  SetFocused(True);
  inherited;
  if SysLocale.FarEast and FDataLink.CanModify then
...
procedure TKDBRichEdit.CMExit(var Message: TCMExit);
begin
  try
    FDataLink.UpdateRecord;
  except
...
procedure TKDBRichEdit.SetAutoDisplay(Value: Boolean);
begin
  if FAutoDisplay <> Value then
  begin
    FAutoDisplay := Value;
...
procedure TKDBRichEdit.WMLButtonDblClk(var Message: TWMLButtonDblClk);
begin
  if not FMemoLoaded then LoadMemo else inherited;
end;

procedure TKDBRichEdit.WMCut(var Message: TMessage);
begin
  BeginEditing;
  inherited;
end;

procedure TKDBRichEdit.WMPaste(var Message: TMessage);
begin
  BeginEditing;
  inherited;
end;

procedure TKDBRichEdit.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := Integer(FDataLink);
end;


function TKDBRichEdit.ExecuteAction(Action: TBasicAction): Boolean;
begin
  Result := inherited ExecuteAction(Action) or (FDataLink <> nil) and
    FDataLink.ExecuteAction(Action);
end;

function TKDBRichEdit.UpdateAction(Action: TBasicAction): Boolean;
begin
  Result := inherited UpdateAction(Action) or (FDataLink <> nil) and
    FDataLink.UpdateAction(Action);
end;
